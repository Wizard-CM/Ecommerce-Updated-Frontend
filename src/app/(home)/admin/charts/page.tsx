...
const page = () => {
  ...
  const chartDataTwelveMonth = barData?.twelveMonthBarChartData;
          ...
          <div className="bg-gray-800/80 backdrop-blur-sm rounded-xl p-4 md:p-6 shadow-lg border border-purple-500/10 transform transition-all duration-300 hover:shadow-purple-500/20">
            ...
            <div className="w-full">
              <BarC
                ...
                data2={chartDataSixMonth?.sixMonthUsersArray || [] }
                label1="Products"
                label2="Users"
                backgroundColor1="#7e3dff"
                backgroundColor2="#ff5050"
                labels={activeTab === 'sixMonth' ? dynamicMonthDataSixMonth : dynamicMonthDataTwelveMonth}
              />
            </div>
          </div>
        </div>
